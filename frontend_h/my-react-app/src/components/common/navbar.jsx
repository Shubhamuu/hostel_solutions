        ...
        <div className="hidden md:flex items-center gap-2">
          {isAuthPage ? (
            <>
              <Link
                to="/"
                className="px-4 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/10 rounded-lg"
              >
                Home
              </Link>
              <Link
              ...
              <Link
                to="/register"
                className="px-4 py-2 rounded-lg bg-gradient-to-r from-amber-500 to-orange-500 text-black font-semibold shadow-lg"
              >
                Register
              </Link>
            </>
